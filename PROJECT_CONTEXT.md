...
- Сейчас проект остается Trud Mini App для реального рабочего пилота.
- TRUD — первый pilot workspace, а не финальный единственный клиент продукта.
- Будущее направление — Bar Ops OS для кофеен и небольшого общепита.
- Не внедрять SaaS-функции преждевременно без отдельной явной задачи.
- Любые будущие изменения должны по возможности не усиливать Trud-specific допущения там, где их позже придется убирать.
